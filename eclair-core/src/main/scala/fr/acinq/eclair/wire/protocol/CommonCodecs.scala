...
object CommonCodecs {
  ...
  val satoshiSigned: Codec[Satoshi] = int64.xmapc(l => Satoshi(l))(_.toLong)
  ...
  val bytes64: Codec[ByteVector64] = bytes(64).as[ByteVector64]
  val variableSigs: Codec[ByteVector] = variableSizeBytes(uint16, bytes)
